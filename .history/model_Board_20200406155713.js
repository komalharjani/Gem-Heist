...
function captureAlarm() {
    //console.log(event.target.getAttribute("row"),event.target.getAttribute("col"));
    let currRow = event.target.getAttribute("row");
    let currCol = event.target.getAttribute("col");
