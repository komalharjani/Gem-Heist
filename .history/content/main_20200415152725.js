  ...
  makeMove: async function (event) {
    ...
    switch(outcome[1]){ 
      ...
      case 4:
        ...
        if(view_playerStatus.outcome == "win") {
          document.getElementById("notice").innerHTML = "You have won";
          alert(" You have" + outcome[2].value);
        }
        //kill game?
    } 
...
const view_game = {
  init: function () {
    ...
    document.getElementById("score").innerHTML = player.gems;
    this.deactivate();
    this.gemChar = "&#128142";
  },
