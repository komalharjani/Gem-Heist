    ...
    let turnPolling = setInterval(async function () {
      ...
      if(myTurn[0]!=true&&myTurn[0]!=false){
        ...
        for(let i =0; i <myTurn[0].length; i++) {
          ...
          //  console.log(myTurn[0][j].id);
            // console.log(gameResult + gameUserIds);
            // console.log(myTurn[0][j].outcome);
            // console.log(myTurn[0][j].id);
            console.log(myTurn[0][i].id + " has " + myTurn[0][i].outcome);
            document.getElementById("notice").innerHTML = myTurn[0][i].id + " has " + myTurn[0][i].outcome;
            document.getElementById("notice").innerHTML.append = myTurn[0][i].id + " has " + myTurn[0][i].outcome;
            
            // if(myTurn[0][j].outcome == "win") {
            //   let winner = myTurn[0][j].id;
            //   document.getElementById("notice").innerHTML = winner + " has won.";
            // }
            // if(myTurn[0][j].outcome == "draw") {
            //   let draw = myTurn[0][j].id;
            //   document.getElementById("notice").innerHTML.append = draw + " has drawn.";
            // }
