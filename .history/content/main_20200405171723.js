    ...
    for (var i = 0; i < height; i++) {
        ...
        for (var j = 0; j < width; j++) {
            ...
            if (j % 2 && i % 2) { //identify gem cells
                ...
                cell.onclick = function() {                 //move outside this function - how?
                  this.innerHTML  = "name";
                  //enqueue this
                }
            }
        ...
        <h2>Start a new Game</h2>
          <h4>Options</h4>
            <div class="box"><br>
                ...
                <input type="range" min="3" max="20" value="3" step="3" oninput="document.getElementById('demo').innerHTML=this.value;model.gems=this.value;" class="slider" id="myRange"></input>
