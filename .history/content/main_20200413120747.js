  ...
  init: function () {
    ...
    this.html1 = `<section>
          ...
          <div class="card">
            ...
            <input type="range" min="3" max="20" value="3" oninput="document.getElementById('demo').innerHTML=this.value;model.gemsHeight=this.value;" class="slider" id="widthRange"></input>
