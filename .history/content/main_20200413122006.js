  ...
  init: function () {
    ...
    this.html1 = `<section>
          ...
          <div class="card">
            ...
            <input type="range" min="3" max="20" value="3" model.gems=this.value;" class="slider" id="widthRange"></input><br>
            <p>Value: <span id="demo">3</span></p>

            <label for="heightRange">Height</label><br>
            <input type="range" min="3" max="20" value="3" ;model.gemsHeight=this.value;" class="slider" id="heightRange"></input><br>
            <p>Value: <span id="demo">3</span><p>
