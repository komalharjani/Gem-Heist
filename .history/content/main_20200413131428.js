  ...
  init: function () {
    ...
    this.html1 = `<section>
          ...
          <div class="card">
            ...
            <input type="range" min="2" max="10" value="3" oninput="document.getElementById('widthDisplay').innerHTML=this.value;model.gems=this.value;" class="slider" id="widthRange"></input>
