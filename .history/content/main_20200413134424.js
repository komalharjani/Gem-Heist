...
const view_game = {
  ...
  deactivate: function () {
    document.getElementById("notTurn").innerHTML = "Not your turn or not enough players yet.";
  ...
  activate: function () {
    document.getElementById("turn").innerHTML = "It's your turn now";
    document.getElementById("makeMove").addEventListener('click', controller.makeMove);
