...
function captureAlarm() {
    ...
    for(let i=0; i <temp.length; i++) {
        let thisRow = temp[i].getAttribute("row");
        let thisCol = temp[i].getAttribute("col");
        console.log(pieces[thisRow][thisCol]);
        let alarmUp = (pieces[thisRow-1][thisCol]);
        let alarmLeft = (pieces[currRow-1][currCol-1]);
        console.log(alarmUp);
