...
function captureAlarm() {
    ...
    let down = pieces[currRow+1 >=0 ][currCol];
    let downRight = pieces[currRow+1 < pieces.length][currCol-1];
    ...
    if ((up.className || right.className || left.className || upRight.className || upLeft.className) == "gem") {
        console.log(up);
        //if (x == 3) {
            //console.log(x);
        }
